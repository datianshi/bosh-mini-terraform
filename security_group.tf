...
resource "aws_security_group" "directorSG" {
    ...
    ingress {
        ...
        to_port = 0
        protocol = "-1"
        cidr_blocks = ["${aws_subnet.PcfVpcPublicSubnet_az1.cidr_block}","${aws_subnet.PcfVpcPublicSubnet_az2.cidr_block}"]
    }
    ingress {
        from_port = 0
        to_port = 0
    ...
    ingress {
        ...
        to_port = 0
        protocol = "-1"
        cidr_blocks = ["${aws_subnet.PcfVpcPrivateSubnet_az2.cidr_block}"]
    }
    egress {
        from_port = 0
        to_port = 0
